...
def generate_cf_bundle(
    ...
    Args:
        ...
        durable_objects: True for the Durable Objects target — its bundle is
            completed by the ``pywire_do.py`` class + wrangler migrations.
            False for the stateless edge target — that bundle carries no
            Durable Object class and needs no wrangler migrations.
    ...
    routes_source = _generate_routes_module(
        artifact_map, bundle_pkg, app_module, app_attr, durable_objects=durable_objects
    )
...
def _generate_routes_module(
    ...
    if durable_objects:
        header = '"""Auto-generated by pywire build --platform cloudflare."""'
    else:
        header = (
            '"""Auto-generated by pywire build --platform cloudflare-edge '
